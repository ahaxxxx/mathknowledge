...
- 补语从句填入动词、名词或形容词要求的内容位置。
- 状语从句建立时间、原因、条件、让步或目的关系。
- 间接疑问从句保留疑问意义，但使用陈述语序。
- `that` 在内容从句中通常不充当内部成分；关系代词则在从句内部占位置。
- 从属连接词不仅连接句子，还规定两个命题之间的逻辑关系。

## 逐句精读

### 句子 1
> The authors argue that the effect is temporary.
