...
- **认识情态**评估命题真假：`may`, `must`, `cannot`。
- **义务情态**规定行动：`must`, `should`, `may`。
- `would` 常建立假设世界、过去视角中的将来或反复行为。
- 反事实条件句把实际世界与替代世界对比，并不只是一套动词变形。
- 情态强度不是固定刻度；证据、语境和否定范围都会改变解释。

## 逐句精读

### 句子 1
> The discrepancy may reflect measurement error.
