...
- 名词化把过程重新包装成可被限定、比较和指代的对象。
- `of` 短语可能表示施事、受事、内容或属性，不能机械翻译。
- 名词化常省略时态和情态，读者需要从上下文恢复。
- 解压缩不是改写文风，而是检验隐藏参与者和逻辑。
- 名词化有组织篇章的价值；问题在于无意识接受其隐含前提。

## 逐句精读

### 句子 1
> The implementation of the policy was uneven.
