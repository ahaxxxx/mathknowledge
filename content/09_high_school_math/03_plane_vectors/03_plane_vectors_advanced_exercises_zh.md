...
1. 考点 56 讲解的“基本概念辨析”，对应 A 组：线性运算、相等向量与命题辨析。
2. 考点 56 讲解的“线性运算、利用线性运算求参数”，对应 B 组：基底分解、分点与参数表示。
3. 考点 56 讲解的“共线定理”，对应 C 组：共线、三点共线与取值范围。
4. 考点 57 讲解与练习中的“坐标运算、夹角、投影、垂直、参数”，对应 D、E 组：数量积、投影、垂直与长度平方。
5. 考点 58 讲解与练习中的“判断三角形形状、四心、面积、最值范围”，对应 F、G 组：三角形形状判断与向量应用。

课堂上可以按这个表追问学生：这道题为什么属于这一类？如果把“中点”改为“三等分点”，如果把“垂直”改为“夹角为 $60^\circ$”，原方法要怎么改？
