...
$$
\sin\alpha=-\frac{15}{17},\qquad
\cos\alpha=\frac{8}{17},\qquad
\tan\alpha=-\frac{15}{8}.
$$
最后用点所在象限检查符号。
:::
...
$$
\sin\alpha=-\frac{24}{25},\qquad
\cos\alpha=-\frac{7}{25},\qquad
\tan\alpha=\frac{24}{7}.
$$
最后用点所在象限检查符号。
:::
...
分子分母同除以 $\cos\alpha$，得
$$
\frac{3\tan\alpha-2}{2\tan\alpha+1}
=5.
$$
:::
...
分子分母同除以 $\cos\alpha$，得
$$
\frac{2\tan\alpha-5}{3\tan\alpha+1}
=\frac{9}{5}.
$$
:::
...
:::solution 查看解析
核心不是背结论，而是令 $u=\omega x+\varphi$，回到母函数单调区间。
$\sin u$ 在 $\left[-\frac\pi2+2k\pi,\frac\pi2+2k\pi\right]$ 上递增。令 $u=2x+\frac\pi3$ 后解不等式即可。
所以单调递增区间为
$$
...
:::solution 查看解析
核心不是背结论，而是令 $u=\omega x+\varphi$，回到母函数单调区间。
$\cos u$ 在 $[2k\pi,\pi+2k\pi]$ 上递减。令 $u=2x-\frac\pi3$。
所以单调递减区间为
$$
...
:::solution 查看解析
核心不是背结论，而是令 $u=\omega x+\varphi$，回到母函数单调区间。
$\tan u$ 在每个定义区间 $\left(-\frac\pi2+k\pi,\frac\pi2+k\pi\right)$ 上递增。
所以单调递增区间为
$$
...
:::solution 查看解析
核心不是背结论，而是令 $u=\omega x+\varphi$，回到母函数单调区间。
前面的负号会把正弦的递减区间变成原函数的递增区间。令 $u=x-\frac\pi6$，取 $u\in\left[\frac\pi2+2k\pi,\frac{3\pi}2+2k\pi\right]$。
所以单调递增区间为
$$
...
:::solution 查看解析
核心不是背结论，而是令 $u=\omega x+\varphi$，回到母函数单调区间。
令 $u=3x-\frac\pi2$，把 $u$ 放进正弦的递增区间，再除以 3。
所以单调递增区间为
$$
...
:::solution 查看解析
核心不是背结论，而是令 $u=\omega x+\varphi$，回到母函数单调区间。
$\cos u$ 在 $[-\pi+2k\pi,2k\pi]$ 上递增。令 $u=x+\frac\pi4$。
所以单调递增区间为
$$
...
:::solution 查看解析
$\sin u$ 的对称轴来自 $u=\frac\pi2+k\pi$，对称中心来自 $u=k\pi$。
所以对称轴为
$$
...
:::solution 查看解析
$\cos u$ 的对称轴来自 $u=k\pi$，对称中心来自 $u=\frac\pi2+k\pi$。
所以对称轴为
$$
...
:::solution 查看解析
$\tan u$ 没有对称轴；中心来自 $u=k\pi$，上下平移后中心纵坐标为 1。
所以对称轴为
$$
\text{无对称轴},
$$
...
:::solution 查看解析
$\sin u$ 的轴是峰谷位置 $u=\frac\pi2+k\pi$，中心纵坐标随 $b=-3$ 下移。
所以对称轴为
$$
x=\frac{3\pi}4+k\pi,
$$
...
:::solution 查看解析
$\cos u$ 的轴仍来自 $u=k\pi$；负号只交换峰谷，不改变轴和中心的位置。
所以对称轴为
$$
x=-\frac\pi{12}+\frac{k\pi}{2},
$$
...
:::solution 查看解析
$\tan u$ 的对称中心来自 $u=k\pi$。令 $u=3x+\frac\pi3$ 后解出 $x$。
所以对称轴为
$$
\text{无对称轴},
$$
...
:::solution 查看解析
给定区间值域题必须先看内层角的实际范围，不能直接套全局值域。
这个区间经过 $\frac\pi2$，所以 $\sin x$ 能取到最大值 1，端点值都是 $\frac12$。
所以值域为
$$
\left[\frac12,1\right].
$$
...
:::solution 查看解析
给定区间值域题必须先看内层角的实际范围，不能直接套全局值域。
令 $u=2x-\frac\pi3$，则 $u\in\left[-\frac\pi3,\frac{2\pi}3\right]$，$\sin u\in\left[-\frac{\sqrt3}2,1\right]$。
所以值域为
$$
[1-\sqrt3,3].
$$
...
:::solution 查看解析
给定区间值域题必须先看内层角的实际范围，不能直接套全局值域。
令 $u=x+\frac\pi4$，则 $u\in\left[\frac\pi4,\frac{3\pi}4\right]$，余弦从正到负且经过 $\frac\pi2$。
所以值域为
$$
...
:::solution 查看解析
给定区间值域题必须先看内层角的实际范围，不能直接套全局值域。
令 $u=x-\frac\pi4$，则 $u\in\left[0,\frac\pi{12}\right]$，正切在该区间递增，$\tan\frac\pi{12}=2-\sqrt3$。
所以值域为
$$
[0,2-\sqrt3].
$$
...
:::solution 查看解析
给定区间值域题必须先看内层角的实际范围，不能直接套全局值域。
区间内包含 $\frac\pi2$，所以 $\sin^2x$ 最大为 1；端点平方分别是 $\frac14$ 与 $\frac34$，最小为 $\frac14$。
所以值域为
$$
\left[\frac14,1\right].
$$
...
:::solution 查看解析
先由最高点、最低点、周期和特殊点依次确定 $A,b,\omega,\varphi$。
$A=\frac{3-(-1)}2=2$，$b=\frac{3+(-1)}2=1$，$T=\pi$ 给出 $\omega=2$。
所以可取
$$
y=2\sin2x+1.
$$
...
:::solution 查看解析
先由最高点、最低点、周期和特殊点依次确定 $A,b,\omega,\varphi$。
$A=3,\ b=2$。最大值要求 $2\cdot\frac\pi{12}+\varphi=\frac\pi2$，所以 $\varphi=\frac\pi3$。
所以可取
$$
...
:::solution 查看解析
先由最高点、最低点、周期和特殊点依次确定 $A,b,\omega,\varphi$。
$A=3,\ b=-2$。最小值要求 $2\cdot\frac\pi6+\varphi=\pi$，所以 $\varphi=\frac{2\pi}3$。
所以可取
$$
...
:::solution 查看解析
先由最高点、最低点、周期和特殊点依次确定 $A,b,\omega,\varphi$。
$A=2$，相邻最大点距离就是周期，所以 $T=\pi,\omega=2$。最大值要求 $2\cdot\frac\pi6+\varphi=\frac\pi2$，得 $\varphi=\frac\pi6$。
所以可取
$$
y=2\sin(2x+\frac\pi6).
$$
